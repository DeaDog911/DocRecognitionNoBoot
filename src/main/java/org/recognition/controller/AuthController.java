...
public class AuthController implements WebMvcConfigurer {
    ...
    private MimeMessage constructEmail(String subject, String body,
        ...
        helper.setFrom("springstudyproject175@mail.ru");
        return mimeMessage;
    }
